#!/usr/bin/env python3
"""
Pipeline đối chiếu và hợp nhất sản phẩm 'vớt' được từ Phase 3 vào Dataset chính.
"""
...
RETRY_PARTS_DIR = Path("data/output/retry_pass3/parts")
...
def main():
    print("=" * 70)
    print("🔄 BẮT ĐẦU ĐỐI CHIẾU & HỢP NHẤT DỮ LIỆU PHASE 3 VÀO DATASET CHÍNH")
    print("=" * 70)

    recovered = load_recovered_products()
    print(f"🌟 Tổng sản phẩm 'vớt' được từ Phase 3: {len(recovered):,} sản phẩm.")

    if not recovered:
        print("ℹ️ Chưa có sản phẩm mới nào được vớt từ Phase 3.")
        return

    # 1. Đọc Dataset chính hiện tại (Phase 1 + 2)
    main_products = {}
    ...
    print("=" * 70)
    print("🎉 HOÀN TẤT ĐỐI CHIẾU & HỢP NHẤT DỮ LIỆU PHASE 3 THÀNH CÔNG!")
