...
$PYTHON_BIN main.py $COMMON_ARGS --start-batch 1 --end-batch 19 \
...
$PYTHON_BIN main.py $COMMON_ARGS --start-batch 20 --end-batch 38 \
...
$PYTHON_BIN main.py $COMMON_ARGS --start-batch 39 --end-batch 57 \
...
$PYTHON_BIN main.py $COMMON_ARGS --start-batch 58 --end-batch 76 \
...
$PYTHON_BIN main.py $COMMON_ARGS --start-batch 77 --end-batch 95 \
...
echo "📊 Theo dõi Dashboard thời gian thực: python3 check_retry_status.py"
echo "📄 Xem live log: tail -f logs/retry_p1.log logs/retry_p2.log logs/retry_p3.log logs/retry_p4.log logs/retry_p5.log"
echo "🛑 Dừng toàn bộ tiến trình: ./stop_retry_pass2.sh"
echo "======================================================================"
